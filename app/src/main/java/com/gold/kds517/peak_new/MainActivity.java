package com.gold.kds517.peak_new;
...
import com.gold.kds517.peak_new.activity.LoginActivity;
import com.gold.kds517.peak_new.activity.SplashActivity;
import com.gold.kds517.peak_new.apps.Constants;
import com.gold.kds517.peak_new.apps.FirstServer;
import com.gold.kds517.peak_new.apps.MyApp;
import com.gold.kds517.peak_new.dialog.UpdateDlg;
...
import static com.gold.kds517.peak_new.apps.MyApp.num_server;
...
//        });
        ...
        try {
            ...
            server_editor.putString("url1", new String (Base64.decode(getOne(), Base64.DEFAULT)));
            Log.e("url1",new String (Base64.decode(getOne(), Base64.DEFAULT)));
            server_editor.putString("url2",new String (Base64.decode(getTwo(), Base64.DEFAULT)));
            Log.e("url2",new String (Base64.decode(getTwo(), Base64.DEFAULT)));
            server_editor.putString("url3",new String (Base64.decode(getThree(), Base64.DEFAULT)));
            Log.e("url3",new String (Base64.decode(getThree(), Base64.DEFAULT)));
            server_editor.apply();
        }catch (Exception e){
